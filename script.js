        ...
        alternativas: [
            {
                ...
                afirmacao:[
                     ...
                     "Achou assustador pensar na velocidade da com que a tecnologia eesta avançando"
                ]
            },
            {
...
functiona aleatorio (lista){
    const poicao = math.random(Math.random()*lista.length);
